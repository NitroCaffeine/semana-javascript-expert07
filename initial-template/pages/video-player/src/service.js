...
export default class Service {
    ...
    async handBlinkDetection(video) {
        ...
        for (const prediction of predictions) {
            ...
            if (!blinkedLeftEye | !blinkedRightEye | !blinked) continue;
    ...
    async  #estimateFaces(video) {
        return this.#model.estimateFaces({ input: video, returnTensors: false, flipHorizontal: true, predictIrises: true })
    }
